...
impl Camera {
    ...
    pub fn on_player_move(&mut self, player_position: Point) {
        let adapted_player_position = Point::new(
            ...
            Self::trim_value(DISPLAY_HEIGHT/2, player_position.y, SCREEN_HEIGHT - DISPLAY_HEIGHT/2),
        );

        self.left_x = adapted_player_position.x - DISPLAY_WIDTH / 2;
        self.right_x = adapted_player_position.x + DISPLAY_WIDTH / 2;
        self.top_y = adapted_player_position.y - DISPLAY_HEIGHT / 2;
        self.bottom_y = adapted_player_position.y + DISPLAY_HEIGHT / 2;
    }
}
